...
class Pregunta_Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            val progressBarPregunta = view.findViewById<ProgressBar>(R.id.progress_Explicacion_pregunta)
            progressBarPregunta.max = 5
            progressBarPregunta.progress = id_preg - 2
            ...
            btn_pregunta1.setOnClickListener {
                if (btn_pregunta1.text == texto_button.getString("respuesta")){
                    ...
                    ObjectAnimator.ofInt(progressBarPregunta, "progress", id_preg).start()
            ...
            btn_pregunta3.setOnClickListener{
                if (btn_pregunta3.text == texto_button.getString("respuesta")){
                    btn_pregunta3.setBackgroundColor(Color.parseColor("#4CAF50"))
                    ObjectAnimator.ofInt(progressBarPregunta, "progress", id_preg).start()
                    Continuar.isEnabled = true
                }else{
    ...
    suspend fun Cuestion() {
        ...
        val stringRequest = object : JsonObjectRequest(
            ...
            { response ->
                ...
                builder.setTitle("Has completado el nivel")
