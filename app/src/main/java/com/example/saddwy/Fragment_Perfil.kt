...
class Fragment_Perfil : Fragment() {
    ...
    override fun onCreateView(
        ...
        val progressBar = view.findViewById<ProgressBar>(R.id.progress_Java)
        val progress = 50
        // Aquí puedes configurar el ProgressBar como quieras
        // Por ejemplo, para mostrarlo de manera indefinida
